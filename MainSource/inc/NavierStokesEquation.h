...
/**
 * Class which encapsulates the Initial Condition for the velocity. This is currently implemented as a zero function.
 */
template <int dim>
...
private:
    ...
    /* Amount of global refinement iterations applied to the mesh. */
    unsigned int globalRefinementLevel;
