...
#ifndef CAHN_HILLIARD_EQUATION_H_
#define CAHN_HILLIARD_EQUATION_H_ 
 ...
 */
template <int dim>
class PhaseForcingFunction : public Function<dim>{
public:
    PhaseForcingFunction() : Function<dim>(){}
 ...
 */
template <int dim>
class ChemicalPotentialForcingFunction : public Function<dim>{
public:
    ChemicalPotentialForcingFunction() : Function<dim>(){}
