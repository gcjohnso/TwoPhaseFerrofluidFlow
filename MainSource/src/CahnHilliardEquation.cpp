 ...
 */
template<int dim>
void CahnHilliardEquation<dim>::initializeSystemAndRefineInitialData(){
    CHDoFHandler.clear();
    triangulation.clear();
 ...
 */
template<int dim>
void CahnHilliardEquation<dim>::initializeNSDoFs(){
    //Navier-Stokes
 ...
 */
template<int dim>
void CahnHilliardEquation<dim>::assembleCHMassAndStiffnessMatrices(){
 ...
 */
template<int dim>
void CahnHilliardEquation<dim>::createCHPhaseMatrixAndPreconditioner(){
    CHPhaseMatrix = 0;
 ...
 */
template<int dim>
void CahnHilliardEquation<dim>::assembleCHRHS(){
    CHPhaseRHS = 0;
    ...
    const PhaseForcingFunction<dim> phaseForcingFunction;
    std::vector<double> phaseForcingValue(numQuadraturePoints);
    const ChemicalPotentialForcingFunction<dim> chemicalPotentialForcingFunction;
 ...
 */
template<int dim>
void CahnHilliardEquation<dim>::createCHPhaseReducedRHS(){
    CHReducedPhaseRHS = 0;
    CHScratchVector = 0;
 ...
 */
template<int dim>
void CahnHilliardEquation<dim>::solveCHPhase(){
 ...
 */
template<int dim>
void CahnHilliardEquation<dim>::createCHChemicalPotentialReducedRHS(){
 ...
 */
template<int dim>
void CahnHilliardEquation<dim>::outputPhase(){
    DataOut<dim> dataOut;
    ...
    filename << "/home/werdho/src/UMD/AMSC664/TwoPhaseFerrofluidFlow/output/CH-" << Utilities::int_to_string(currTimeStep, 5) << ".vtk";
 ...
 */
template<int dim>
void CahnHilliardEquation<dim>::performAdaptiveRefinement(){
    computeEstimator();
 ...
 */
template<int dim>
void CahnHilliardEquation<dim>::computeEstimator(){
 ...
 */ 
template<int dim>
void CahnHilliardEquation<dim>::setupNSDoF(){
 ...
 */
template<int dim>
void CahnHilliardEquation<dim>::setupCHDoF(){
    CHDoFHandler.distribute_dofs(CHFE);
 ...
 */
template<int dim>
void CahnHilliardEquation<dim>::initializeMesh(){
 ...
 */
template<int dim>
double CahnHilliardEquation<dim>::truncatedDoubleWellValue(const double value){
    if(value < -1.0){
...
template class CahnHilliardEquation<2>;
/*
 * Default constructor
 */
template<int dim>
 ...
 */
template<int dim>
double PhaseForcingFunction<dim>::value(const Point<dim> &p, const unsigned int) const{
    return 0;
}
 ...
 */
template<int dim>
double ChemicalPotentialForcingFunction<dim>::value(const Point<dim> &p, const unsigned int) const{
    return 0;
}
