 ...
 */
template<int dim>
CahnHilliardUnitTest2<dim>::CahnHilliardUnitTest2()
:
eps(0.001),
gamma(.2),
eta(.000001),
 ...
 */
template<int dim>
void CahnHilliardUnitTest2<dim>::initializeSystemAndRefineInitialData(){
    CHDoFHandler.clear();
    triangulation.clear();
 ...
 */
template<int dim>
void CahnHilliardUnitTest2<dim>::initializeNSDoFs(){
    //Navier-Stokes
 ...
 */
template<int dim>
void CahnHilliardUnitTest2<dim>::assembleCHMassAndStiffnessMatrices(){
 ...
 */
template<int dim>
void CahnHilliardUnitTest2<dim>::createCHPhaseMatrixAndPreconditioner(){
    CHPhaseMatrix = 0;
 ...
 */
template<int dim>
void CahnHilliardUnitTest2<dim>::assembleCHRHS(){
    CHPhaseRHS = 0;
    ...
    const PhaseForcingFunction2<dim> phaseForcingFunction;
    std::vector<double> phaseForcingValue(numQuadraturePoints);
    const ChemicalPotentialForcingFunction2<dim> chemicalPotentialForcingFunction;
 ...
 */
template<int dim>
void CahnHilliardUnitTest2<dim>::createCHPhaseReducedRHS(){
    CHReducedPhaseRHS = 0;
    CHScratchVector = 0;
 ...
 */
template<int dim>
void CahnHilliardUnitTest2<dim>::solveCHPhase(){
 ...
 */
template<int dim>
void CahnHilliardUnitTest2<dim>::createCHChemicalPotentialReducedRHS(){
 ...
 */
template<int dim>
void CahnHilliardUnitTest2<dim>::outputPhase(){
    DataOut<dim> dataOut;
    ...
    filename << "/home/werdho/src/UMD/AMSC664/TwoPhaseFerrofluidFlow/testing/output/CHUnitTest2-" << Utilities::int_to_string(currTimeStep, 5) << ".vtk";
 ...
 */
template<int dim>
void CahnHilliardUnitTest2<dim>::performAdaptiveRefinement(){
    computeEstimator();
 ...
 */
template<int dim>
void CahnHilliardUnitTest2<dim>::computeEstimator(){
 ...
 */ 
template<int dim>
void CahnHilliardUnitTest2<dim>::setupNSDoF(){
 ...
 */
template<int dim>
void CahnHilliardUnitTest2<dim>::setupCHDoF(){
    CHDoFHandler.distribute_dofs(CHFE);
 ...
 */
template<int dim>
void CahnHilliardUnitTest2<dim>::run(){
 ...
 */
template<int dim>
void CahnHilliardUnitTest2<dim>::initializeMesh(){
 ...
 */
template<int dim>
double CahnHilliardUnitTest2<dim>::truncatedDoubleWellValue(const double value){
    if(value < -1.0){
...
template class CahnHilliardUnitTest2<2>;
/*
 * Default constructor
 */
template<int dim>
PhaseInitialCondition2<dim>::PhaseInitialCondition2() : Function<dim>()
{
}
 ...
 */
template<int dim>
double PhaseInitialCondition2<dim>::value(const Point<dim> &p, const unsigned int) const{
 ...
 */
template<int dim>
double PhaseForcingFunction2<dim>::value(const Point<dim> &p, const unsigned int) const{
    return 0;
}
 ...
 */
template<int dim>
double ChemicalPotentialForcingFunction2<dim>::value(const Point<dim> &p, const unsigned int) const{
    return 0;
}
 ...
 * Default constructor
 */
MatrixInverseAction2::MatrixInverseAction2()
{
}
 ...
 * that CG will use.
 */
void MatrixInverseAction2::initialize(TrilinosWrappers::SparseMatrix &A){
    matrix = &A;
 ...
 */
void MatrixInverseAction2::vmult(TrilinosWrappers::MPI::Vector &dst, const TrilinosWrappers::MPI::Vector &src){
 ...
 * Default constructor
 */
CHReducedPhaseMatrixAction2::CHReducedPhaseMatrixAction2()
{
}
 ...
 */
void CHReducedPhaseMatrixAction2::initialize(TrilinosWrappers::SparseMatrix &MassMatrix, TrilinosWrappers::SparseMatrix &StiffnessMatrix, TrilinosWrappers::SparseMatrix &CHPhaseMatrix, const double dt, const double eps, const double gamma, const double eta){
 ...
 */
void CHReducedPhaseMatrixAction2::vmult(TrilinosWrappers::MPI::Vector &dst, const TrilinosWrappers::MPI::Vector &src) const{
    //Compute KM^{-1}K*src
