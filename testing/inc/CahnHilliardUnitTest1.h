...
#ifndef CAHN_HILLIARD_UNIT_TEST_1_H_
#define CAHN_HILLIARD_UNIT_TEST_1_H_
 ...
 */
template <int dim>
class PhaseInitialCondition1 : public Function<dim>{
public:
    PhaseInitialCondition1();
 ...
 */
template <int dim>
class PhaseForcingFunction1 : public Function<dim>{
public:
    PhaseForcingFunction1() : Function<dim>(){}
 ...
 */
template <int dim>
class ChemicalPotentialForcingFunction1 : public Function<dim>{
public:
    ChemicalPotentialForcingFunction1() : Function<dim>(){}
 ...
 */
class MatrixInverseAction1{
public:
    MatrixInverseAction1();
 ...
 */
class CHReducedPhaseMatrixAction1{
public:
    CHReducedPhaseMatrixAction1();
...
private:
    ...
    MatrixInverseAction1 MassInverse;
 ...
 */
template <int dim>
class CahnHilliardUnitTest1{
public:
    CahnHilliardUnitTest1();
...
private:
    ...
    PhaseInitialCondition1<dim> phaseInitialCondition;
    /* Mass matrix */
    ...
    CHReducedPhaseMatrixAction1 CHReducedPhaseMatrix;
    /* Object to compute the action of the inverse of the mass matrix. */
    MatrixInverseAction1 CHMassInverse;
