...
int main(int argc, char *argv[]){
	//Single dipole
	const char filename1[] = "/home/werdho/src/TwoPhaseFerrofluidFlow/AppliedMagnetizingField/config/testDipoles1.txt";
	...
	//Check at t=0 (should be 0)
        ...
        if(abs(values[0][0] - 0) <= tolerance){
            std::cout << "Passing dipole config 1 at point (1,1) at t=0, x value" << std::endl;
            std::cout << "  Comp val: " << values[0][0] << " Actual val: " << 0 << std::endl;
        }
        if(abs(values[0][1] - 0) <= tolerance){
            std::cout << "Passing dipole config 1 at point (1,1) at t=0, y value" << std::endl;
            std::cout << "  Comp val: " << values[0][1] << " Actual val: " << 0 << std::endl;
        }
        if(abs(values[1][0] - 0) <= tolerance){
                std::cout << "Passing dipole config 1 at point (2,1) at t=0, x value" << std::endl;
                std::cout << "  Comp val: " << values[1][0] << " Actual val: " << 0 << std::endl;
            }
        if(abs(values[1][1] - 0) <= tolerance){
            std::cout << "Passing dipole config 1 at point (2,1) at t=0, y value" << std::endl;
        ...
        if(abs(values[0][0] - (2*(-2)*(-2)/64.0)*(1-0)*(60/3.5)) <= tolerance){
            std::cout << "Passing dipole config 1 at point (1,1) at t=1, x value" << std::endl;
        ...
        if(abs(values[0][0] - 0) <= tolerance){
            std::cout << "Passing dipole config 2 at point (1,1) at t=.999, x value" << std::endl;
            std::cout << "  Comp val: " << values[0][0] << " Actual val: " << 0 << std::endl;
        }
        if(abs(values[0][1] - 0) <= tolerance){
            std::cout << "Passing dipole config 2 at point (1,1) at t=.999, y value" << std::endl;
            std::cout << "  Comp val: " << values[0][1] << " Actual val: " << 0 << std::endl;
        }
        ...
        if(abs(values[0][0] - (2*(-1)*(-1)/4.0 + 0)*(2-1)*60/(3.5-1)) <= tolerance){
            std::cout << "Passing dipole config 2 at point (1,1) at t=2, x value" << std::endl;
        ...
        if(abs(values[0][1] - (-.5 + 2*(-1)*(-1)/4.0- 1)*(2-1)*60/(3.5-1)) <= tolerance){
            std::cout << "Passing dipole config 2 at point (1,1) at t=2, y value" << std::endl;
